...
---
This last weeked, my partners, [Arunav Gupta](https://www.linkedin.com/in/arunav-gupta/), [Kyle Nero](https://www.linkedin.com/in/kylenero/), and I took part in [DataHacks](http://datahacks.tech/) at UC San Diego. Participants were given a dataset and a set of objectives to complete. We were required to create visualizations, analyze the data, and create a fleshed out report in the span of 24 hours. We competed in the advanced track and did an exploratory data analysis Vulcan Value Partners' S&P 500 dataset. Using [Facebook's Prophet](https://facebook.github.io/prophet/), we created forecasting models anaylizing the given time-series data and made a prediction on what features are most indicative in predicting the S&P 500! This was all of our first DataHacks event so it was quite stressful, but we were very productive in cleaning and analyzing the data over the course of 24 hours!

Please feel free to check out our project at the [Github repository](https://github.com/brianjhuang/datahacks-2021) OR the [presentation website](https://brianjhuang.github.io/datahacks-2021/#/)!

# DataHacks 2021 Advanced Track Vulcan Dataset
[Arunav Gupta](https://github.com/agupta01), [Brian Huang](https://github.com/brianjhuang), [Kyle Nero](https://github.com/kylenero99)
...
![logo.png](/assets/img/vulcan.png)
...
![Alt](/assets/img/prophet-hero-icon.jpg)
...
![series%20and%20regression%20coefficients.png](/assets/img/series%20and%20regression%20coefficients.png)

![correlation%20and%20regreesion%20coefficients.png](/assets/img/correlation%20and%20regreesion%20coefficients.png)
...
![results%20of%20hyperparameter%20optimization.png](/assets/img/results of hyperparameter optimization.png)
...
# Visualization:
![spfinal.png](/assets/img/spfinal.png)
