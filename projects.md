...
subtitle:
---
* [**S&P 500 Exploratory Data Analysis (DataHacks 2021)**](https://brianjhuang.github.io/datahacks-2021/#/):
  * Cleaned a dataset containing features that contribute to the S&P 500 provided by Vulcan.
  * Analyzed different time series data sets and concluded what features were most relevant to forecasting the S&P 500.
  * Models were generated using Facebook’s Prophet and the dataset was cleaned using Pandas.
...
* [**Rowing Database**](https://github.com/brianjhuang/rowing_database):
  ...
  * Stored team line-ups and info about individual rowers (height, weight, race times, etc).
  * Front-end coded using HTML. Back-end coded using PHP and SQL. Database was run on an Apache server.
